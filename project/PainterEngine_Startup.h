...
#ifdef PKG_PAINTERENGINE_USING_DEMO
#define PX_APPLICATION_MEMORYPOOL_UI_SIZE 0
#define PX_APPLICATION_MEMORYPOOL_RESOURCES_SIZE 4*1024*1024
#define PX_APPLICATION_MEMORYPOOL_GAME_SIZE 6*1024*1024
#define PX_APPLICATION_MEMORYPOOL_SPACE_SIZE 2*1024*1024
#else
